@csrf
<table class="table" style="font-size: 0.9em; background-color: white; width: 30%">
    <tr>
        <th>Apellido</th>
    ...
    <tr>
        <th>Rnd</th>
        <td style="background-color: #f8f9fa;"><input type="text" name="cPerRnd" value="{{ old('cPerRnd',$persona->cPerRnd) }}"></td>
    </tr>
    <tr>
